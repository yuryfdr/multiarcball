...
namespace{
  bool cur_init=false;
  Glib::RefPtr<Gdk::Cursor> cur_move;
  Glib::RefPtr<Gdk::Cursor> cur_rotate;
  Glib::RefPtr<Gdk::Cursor> cur_zoom;
  Glib::RefPtr<Gdk::Cursor> cur_rotate_x;
  Glib::RefPtr<Gdk::Cursor> cur_rotate_y;
  Glib::RefPtr<Gdk::Cursor> cur_rotate_z;
  Glib::RefPtr<Gdk::Cursor> cur_zoom_w;
};

Gtk::ArcballWidget::ArcballWidget()
  {
    set_can_focus(true); 
    ...
    if(!cur_init){
      cur_move  =Gdk::Cursor::create(Gdk::Display::get_default(),Gdk::Pixbuf::create_from_xpm_data(move_xpm),15,15);
      cur_rotate=Gdk::Cursor::create(Gdk::Display::get_default(),Gdk::Pixbuf::create_from_xpm_data(rot_xpm),15,15);
      cur_rotate_x=Gdk::Cursor::create(Gdk::Display::get_default(),Gdk::Pixbuf::create_from_xpm_data(rot_x_xpm),15,15);
      cur_rotate_y=Gdk::Cursor::create(Gdk::Display::get_default(),Gdk::Pixbuf::create_from_xpm_data(rot_y_xpm),15,15);
      cur_rotate_z=Gdk::Cursor::create(Gdk::Display::get_default(),Gdk::Pixbuf::create_from_xpm_data(rot_z_xpm),15,15);
      cur_zoom  =Gdk::Cursor::create(Gdk::Display::get_default(),Gdk::Pixbuf::create_from_xpm_data(zoom_xpm),0,0);
      cur_zoom_w=Gdk::Cursor::create(Gdk::Display::get_default(),Gdk::Pixbuf::create_from_xpm_data(zoom_w_xpm),0,0);
    }
    cur_init=true;
}
...
void Gtk::ArcballWidget::on_realize()
{
